...
export default function AdminPointsScreen() {
    ...
    const points = useQuery(api.points.getAllPoints);
    ...
    return (
        <View style={styles.container}>
            <View style={styles.header}>
                ...
                <Text style={styles.headerTitle}>All Points</Text>
            </View>
            <Text style={styles.subtitle}>
                {points ? `${points.length} point records` : "Loading..."}
            </Text>
            ...
            <FlatList
                ...
                renderItem={({ item }) => (
                    <View style={styles.card}>
                        ...
                        <Text style={styles.cardDetail}>Activity: {item.activity}</Text>
                ...
                ListEmptyComponent={
                    points ? <Text style={styles.empty}>No point records found.</Text> : null
                }
            />
        </View>
    );
